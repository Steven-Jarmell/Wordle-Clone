				...
				<div className="main-settings-content">
                    <div className="setting">
                        <div className="hard-mode">
                            <p className="setting-title">Hard Mode</p>
                            <p className="setting-description">Any revealed hints must be used in subsequent guesses</p>
                        </div>
						<div className="switch">
							<Switch checked={false} onChange={() => {}} height={22} width={48} uncheckedIcon={false} checkedIcon={false} handleDiameter={18}/>
						</div>
					</div>
					<div className="setting">
					...
					<div className="setting">
						...
						<a href="mailto: jarmellsteve@yahoo.com" target="_blank" rel="noreferrer" className="email-link">Email</a>
					</div>
